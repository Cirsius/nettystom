...
public final class ProxyProtocolDecoder {
    ...
    public static Result parse(SocketAddress originalAddress, NetworkBuffer buffer) throws IOException {
    ...
    public record Result(Status status, SocketAddress clientAddress) {
    }
